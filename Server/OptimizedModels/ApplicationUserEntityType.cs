    ...
    internal partial class ApplicationUserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "AccReporting.Shared.ContextModels.ApplicationUser",
            ...
            var companyDetailID = runtimeEntityType.AddProperty(
                ...
                typeof(int?),
                nullable: true);
            companyDetailID.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var currentSelectedUsers = principalEntityType.AddNavigation("CurrentSelectedUsers",
                ...
                propertyInfo: typeof(CompanyDetail).GetProperty("CurrentSelectedUsers", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(CompanyDetail).GetField("<CurrentSelectedUsers>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
